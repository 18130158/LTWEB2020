        ...
        <div class="row my-2 user__border">
            <div class="col-lg-8 order-lg-2">
                <ul class="nav nav-tabs">
                    <li class="nav-item">
                        <a href="" data-target="#profile" data-toggle="tab" class="nav-link active nav-link-2"><i class="fas fa-user" style="color: #f9a31d;"></i>&nbsp;Tài Khoản Của Tôi</a>
                    </li>
                    <li class="nav-item">
                        <a href="" data-target="#edit" data-toggle="tab" class="nav-link nav-link-2"><i class="fas fa-sticky-note" style="color: #f9a31d;"></i>&nbsp;Đơn Mua Của Tôi</a>
                    </li>
                    <li class="nav-item">
                      <a href="" data-target="#like" data-toggle="tab" class="nav-link nav-link-2"><i class="fas fa-heart" style="color: #f9a31d;"></i>&nbsp;Sản Phẩm Đã Yêu Thích</a>
					</li>
					<li class="nav-item">
                        <a href="" data-target="#messages" data-toggle="tab" class="nav-link nav-link-2"><i class="fas fa-unlock-alt" style="color: #f9a31d;"></i>&nbsp;Thay Đổi Mật Khẩu</a>
                    </li>
					<!-- <li class="nav-item">
						<a href="" data-target="#comment" data-toggle="tab" class="nav-link nav-link-2"><i class="fas fa-comment-dots" style="color: #f9a31d;"></i>&nbsp;Nhận xét</a>
					</li> -->
                </ul>
                        ...
                        <div class="row">
							...
							<div class="row">
								...
								<div class="col-lg-6 col-md-9">
									...
									<br>
							<input class="form-control" type="text" data-toggle="modal" data-target="#exampleModal" name="" style="width: 150px;height: 50px;background-color: #F6F7FB;border: none;" placeholder="Chỉnh sửa địa chỉ">
                            <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog">
                                 <div class="modal-content" style="width: 500px; margin: auto;padding: 15px; padding-top: 56px; padding-left: 34px;" >
                                    ...
                                    <div class="row">
                                      ...
                                      <div class="col-md-6" >
                                        <form>
										  ...
										  <br> 
										  <label style="margin-top: 19px;margin-left: -97px;">Phường/Xã</label>
                                          <div class="form-group ">
                                            <select >
                                      ...
                                      <div class="modal-footer">
										  <br>
                                          <button type="button" class="btn btn-info" data-dismiss="modal" style="background-color: rgb(60, 171, 245);    margin-left: 93px;margin-top: 32px;">Hủy bỏ</button>
                                          <button type="button" class="btn btn-danger" style="background-color: #bd2130;">Đồng ý</button>
                                      </div>
                                    </div>
                                  </div>
                            </div>
							...
							<div class="row">
								...
								<div class="col-lg-6 col-md-9">
									<button type="button" class="btn btn-warning" style="background-color: black;border-color:black;">LƯU</button>
								</div>
                    ...
                    <div class="tab-pane" id="messages">
                      <div class="row">
                          ...
                          <header>
                              ...
                              <div class="content">Để bảo mật tài khoản, vui lòng không chia sẻ mật khẩu cho người khác</div>
						  </header>
						  <hr>
                          <form id="formAcount" class="formAcount validate clearfix">
                              ...
                              <div class="form-group clearfix">
                                  ...
                                  <label class="col-md-3 control-label"></label>
                                  <div class="col-lg-6 col-md-9">
									<button type="button" class="btn btn-warning" style="border-color: black;">LƯU THAY ĐỔI</button>
                                  </div>
                              </div>
                              </div>
                          </form>
            ...
            <div class="col-lg-4 order-lg-1 text-center img-2">
              <div class="img-ava">
                <img src="images/gioithieu/Linh1.png" class="mx-auto img-fluid  d-block" alt="avatar" style="position: relative;">
                <label class="load-ava" >
				<button type="button" class="btn btn-dark" style="width: 150px;height: 50px;top: -119px;color: white;margin-left: 6px;">
					<span>Chọn ảnh</span>
