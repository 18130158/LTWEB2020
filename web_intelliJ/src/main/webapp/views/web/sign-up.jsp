    ...
    <form action="/examples/actions/confirmation.php" method="post" class="form_signup">
        ...
        <div class="form-group">
            <input type="password" class="form-control" name="password" placeholder="Xác nhận mật khẩu"
                   required="required" oninvalid="this.setCustomValidity('Xác nhận lại mật khẩu')"
                   style="font-size: 14px;">
        </div>
        <div class="form-group">
            <button type="submit" class="btn btn-primary btn-lg btn-block">
                <a href="personal_details.jsp" style="text-decoration: none;color: white;">
                    Đăng ký
                </a>
            </button>
        </div>
    </form>
    <p class="text-center small" style="font-size: 14px;">Bạn đã có tài khoản? <a href="login.jsp"
